...
namespace Lab.Models
{
    public class ContaCorrente : Conta
    {
        ...
        public ContaCorrente(int numeroBanco, string numeroAgencia, string numeroConta) : base(numeroBanco, numeroAgencia, numeroConta)
        {
        }
        ...
        public override string MostrarExtrato()
        {
            ...
            builder.Append($"Saldo: {this.Saldo:C2}");
