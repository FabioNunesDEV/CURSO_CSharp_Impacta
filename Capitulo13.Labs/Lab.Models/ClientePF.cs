...
namespace Lab.Models
{
    public class ClientePF : Cliente, IDocumento
    {
        ...
        //construtores
        public ClientePF(string Cpf, string Nome, Sexos Sexo): base(Nome, Sexo)
        {
            this.NumeroDocumento = Cpf;
        }
        public ClientePF(string Cpf, string Nome, Sexos Sexo,int Idade, Endereco endereco): base(Nome, Sexo, Idade)
        {
            this.NumeroDocumento = Cpf;
